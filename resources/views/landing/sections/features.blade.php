<section id="fitur" class="py-16 md:py-24 px-4 md:px-6 relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-50/50">
    ...
    <div class="max-w-7xl mx-auto relative z-10">
        <div class="text-center mb-12 md:mb-16">
            ...
            <p class="text-slate-600 max-w-2xl mx-auto text-base md:text-lg px-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <article class="group p-8 bg-white/70 backdrop-blur-md rounded-[2rem] border border-white shadow-sm hover:shadow-xl hover:shadow-indigo-500/10 transition-all duration-500">
