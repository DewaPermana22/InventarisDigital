<section id="masalah" class="py-16 md:py-24 px-4 md:px-6 relative bg-slate-50/50 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto relative z-10">
        <div class="text-center mb-12 md:mb-16 px-2">
            <h2 data-aos="fade-up" class="text-2xl md:text-4xl font-bold mb-4 text-slate-900 leading-tight">
                Masalah Manajemen Inventaris Manual yang Menghambat Bisnis
            </h2>
            <p data-aos="fade-up" data-aos-delay="200" class="text-slate-600 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <article
                ...
                class="p-6 md:p-8 glass-card rounded-3xl shadow-sm border border-slate-100 hover:border-indigo-200 transition-all duration-300 bg-white/40 backdrop-blur-sm group">
